...
This repository provides the standardized structure, configuration, and tooling for all repos in the hyperpolymath ecosystem. Use it to:
...
# Customize placeholders (see PLACEHOLDERS.md for full list)
sed -i 's/{{PROJECT_NAME}}/my-project/g' Justfile guix.scm README.adoc
...
|`.machine_readable/`
|Project state files (STATE.a2ml, META.a2ml, ECOSYSTEM.a2ml, etc.)

|`.bot_directives/`
|Bot configuration (rhodibot, echidnabot, sustainabot, etc.)

|`contractiles/`
|Contractile system (k9, dust, lust, must, trust)
...
│   ├── humans.txt
│   └── security.txt
├── .machine_readable/         # Project state (a2ml format)
│   ├── STATE.a2ml
│   ├── META.a2ml
│   ├── ECOSYSTEM.a2ml
│   ├── AGENTIC.a2ml
│   ├── NEUROSYM.a2ml
│   └── PLAYBOOK.a2ml
├── .bot_directives/           # Bot configurations
