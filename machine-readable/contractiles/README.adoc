...
Two in-tree citations below are known to be unresolved and are left as
written rather than silently repaired: `docs/CONTRACTILE-SPEC.adoc` does not
exist in this repository, and the "contractile CLI" has never been built --
enforcement currently rides on the CI gates, not on that tool.
====
