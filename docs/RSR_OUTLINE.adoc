...
|`www/`
|Site-operations bundle; RFC-compliant metadata at `www/.well-known/` (security.txt, ai.txt, humans.txt)
...
|`build/guix.scm`
|Guix package definition (canon 1.2.1 guix-primary names `build/`)
