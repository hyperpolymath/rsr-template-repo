...
| `{{PROJECT_KIND}}` | Project kind / category | `library` | .machine_readable/6a2/anchors/ANCHOR.a2ml |
| `{{PROJECT_DOMAIN}}` | Project domain | `formal-methods` | .machine_readable/6a2/anchors/ANCHOR.a2ml |
